/**
 * Job Costing module collection schemas (Phase 3 — Job Costing Foundation).
...
export const jobSchemas: SchemaDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'totalMarkup', type: 'currency', label: 'Total Markup' },
      { name: 'totalPrice', type: 'currency', label: 'Total Price' },
      { name: 'marginPct', type: 'percentage', label: 'Margin %' },
      { name: 'bidDate', type: 'date', label: 'Bid Date' },
      ...
      { name: 'defaultMarkupPct', type: 'percentage', label: 'Default Markup %' },
      { name: 'wonDate', type: 'date', label: 'Won Date' },
      { name: 'lostDate', type: 'date', label: 'Lost Date' },
      { name: 'lostReason', type: 'string', label: 'Lost Reason' },
      { name: 'competitorName', type: 'string', label: 'Competitor Name' },
      { name: 'competitorPrice', type: 'currency', label: 'Competitor Price' },
      { name: 'transferredToBudget', type: 'boolean', label: 'Transferred to Budget' },
      { name: 'budgetId', type: 'id', label: 'Linked Budget' },
    ],
    relations: [
      { foreignKey: 'jobId', collection: 'job/job', type: 'belongsTo', cascade: 'cascade' },
      { foreignKey: 'budgetId', collection: 'job/budget', type: 'belongsTo', cascade: 'nullify' },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: 'parentId', type: 'id', label: 'Parent (Assembly)' },
      ...
      { name: 'unitCost', type: 'currency', label: 'Unit Cost' },
      { name: 'amount', type: 'currency', label: 'Amount (Cost)' },
      { name: 'markupPct', type: 'percentage', label: 'Markup %' },
      { name: 'markupAmount', type: 'currency', label: 'Markup Amount' },
      { name: 'totalPrice', type: 'currency', label: 'Total Price' },
      { name: 'isAssembly', type: 'boolean', label: 'Is Assembly' },
      { name: 'assemblyName', type: 'string', label: 'Assembly Name' },
      { name: 'sortOrder', type: 'number', label: 'Sort Order' },
      { name: 'isAlternate', type: 'boolean', label: 'Is Alternate' },
      { name: 'isAllowance', type: 'boolean', label: 'Is Allowance' },
      { name: 'alternateGroup', type: 'string', label: 'Alternate Group' },
    ],
    relations: [
      { foreignKey: 'estimateId', collection: 'job/estimate', type: 'belongsTo', cascade: 'cascade' },
      { foreignKey: 'parentId', collection: 'job/estimateLine', type: 'belongsTo', cascade: 'nullify' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'description', type: 'string', label: 'Description' },
      { name: 'amount', type: 'currency', label: 'Bid Amount' },
      {
        name: 'status',
        type: 'enum',
        enum: ['solicited', 'received', 'selected', 'rejected'],
        label: 'Status',
      },
      { name: 'receivedDate', type: 'date', label: 'Received Date' },
      { name: 'expirationDate', type: 'date', label: 'Expiration Date' },
      { name: 'notes', type: 'string', label: 'Notes' },
      { name: 'isLowBid', type: 'boolean', label: 'Is Low Bid' },
      { name: 'scopeInclusions', type: 'string', label: 'Scope Inclusions' },
      { name: 'scopeExclusions', type: 'string', label: 'Scope Exclusions' },
      { name: 'bondIncluded', type: 'boolean', label: 'Bond Included' },
